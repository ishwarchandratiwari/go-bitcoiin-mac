...
import (
	...
	"github.com/bitcoiinBT2/go-bitcoiin/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the Bitcoiin2g contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the Bitcoiin2g contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the Bitcoiin2g contract Solidity source to build and bind")
