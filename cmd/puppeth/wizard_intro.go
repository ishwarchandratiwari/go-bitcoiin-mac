...
// setting up a new or managing an existing Bitcoiin2g private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Bitcoiin2g private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Bitcoiin2g network down to  |")
	...
	log.Info("Administering Bitcoiin2g network", "name", w.network)
