...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d git.pirl.io/bitcoiin/go-bitcoiin

    go install git.pirl.io/bitcoiin/go-bitcoiin/cmd/swarm
...
You must have your working copy under `$GOPATH/src/git.pirl.io/bitcoiin/go-bitcoiin`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/git.pirl.io/bitcoiin/go-bitcoiin
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/git.pirl.io/bitcoiin/go-bitcoiin/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://git.pirl.io/bitcoiin/go-bitcoiin/wiki/Code-Review-Guidelines).
