...
see https://git.pirl.io/bitcoiin/go-bitcoiin/issues/2040
Usage:

import (
 "git.pirl.io/bitcoiin/go-bitcoiin/common/httpclient"
 "git.pirl.io/bitcoiin/go-bitcoiin/swarm/api/http"
)
