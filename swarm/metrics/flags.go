// Copyright 2018 The go-bitcoiin2g Authors
...
import (
	...
	bitcoiinGometrics "github.com/bitcoiinBT2/go-bitcoiin/metrics"
	"github.com/bitcoiinBT2/go-bitcoiin/metrics/influxdb"
...
func Setup(ctx *cli.Context) {
	if bitcoiinGometrics.Enabled {
		...
		if enableExport {
			...
			go influxdb.InfluxDBWithTags(bitcoiinGometrics.DefaultRegistry, 10*time.Second, endpoint, database, username, password, "swarm.", map[string]string{
				"host": hosttag,
			})
		}
	}
