...
// Package bitcoiinGo contains the simplified mobile APIs to go-bitcoiin2g.
//
// The scope of this package is *not* to allow writing a custom Bitcoiin2g client
// with pieces plucked from go-bitcoiin2g, rather to allow writing native dapps on
...
// from the go-bitcoiin2g repository. Please adhere to this scoping to prevent this
// package getting unmaintainable.
//
// Wrapping guidelines:
//
// Every type that is to be exposed should be wrapped into its own plain struct,
// which internally contains a single field: the original go-bitcoiin2g version.
