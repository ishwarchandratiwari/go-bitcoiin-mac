...
// Header represents a block header in the Bitcoiin2g blockchain.
type Header struct {
	header *types.Header
}
...
// Block represents an entire block in the Bitcoiin2g blockchain.
type Block struct {
	block *types.Block
}
...
// Transaction represents a single Bitcoiin2g transaction.
...
// Deprecated: use Bitcoiin2gClient.TransactionSender
