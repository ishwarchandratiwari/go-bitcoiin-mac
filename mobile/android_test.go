...
public class AndroidTest extends InstrumentationTestCase {
	...
	public void testInprocNode() {
		...
		try {
			...
			Node node = new Node(getInstrumentation().getContext().getFilesDir() + "/.bitcoiin2g", new NodeConfig());
			node.start();
			...
			Bitcoiin2gClient ec = node.getBitcoiin2gClient();
	...
	// signatures too. Regression test for go-bitcoiin2g issue #14599.
...
func TestAndroid(t *testing.T) {
	...
	for _, dir := range []string{"src/main", "src/androidTest/java/org/bitcoiin2g/bitcoiinGotest", "libs"} {
	...
	gobind := exec.Command("gomobile", "bind", "-javapkg", "org.bitcoiin2g", "github.com/bitcoiinBT2/go-bitcoiin/mobile")
	...
	if err = ioutil.WriteFile(filepath.Join("src", "androidTest", "java", "org", "bitcoiin2g", "bitcoiinGotest", "AndroidTest.java"), []byte(androidTestClass), os.ModePerm); err != nil {
...
<manifest xmlns:android="http://schemas.android.com/apk/res/android"
          package="org.bitcoiin2g.bitcoiinGotest"
