...
// Contains a wrapper for the Bitcoiin2g client.
...
// Bitcoiin2gClient provides access to the Bitcoiin2g APIs.
type Bitcoiin2gClient struct {
	client *ethclient.Client
}

// NewBitcoiin2gClient connects a client to the given URL.
func NewBitcoiin2gClient(rawurl string) (client *Bitcoiin2gClient, _ error) {
	rawClient, err := ethclient.Dial(rawurl)
	return &Bitcoiin2gClient{rawClient}, err
}

// GetBlockByHash returns the given full block.
func (ec *Bitcoiin2gClient) GetBlockByHash(ctx *Context, hash *Hash) (block *Block, _ error) {
...
func (ec *Bitcoiin2gClient) GetBlockByNumber(ctx *Context, number int64) (block *Block, _ error) {
	if number < 0 {
...
func (ec *Bitcoiin2gClient) GetHeaderByHash(ctx *Context, hash *Hash) (header *Header, _ error) {
...
func (ec *Bitcoiin2gClient) GetHeaderByNumber(ctx *Context, number int64) (header *Header, _ error) {
	if number < 0 {
...
func (ec *Bitcoiin2gClient) GetTransactionByHash(ctx *Context, hash *Hash) (tx *Transaction, _ error) {
...
func (ec *Bitcoiin2gClient) GetTransactionSender(ctx *Context, tx *Transaction, blockhash *Hash, index int) (sender *Address, _ error) {
...
func (ec *Bitcoiin2gClient) GetTransactionCount(ctx *Context, hash *Hash) (count int, _ error) {
...
func (ec *Bitcoiin2gClient) GetTransactionInBlock(ctx *Context, hash *Hash, index int) (tx *Transaction, _ error) {
...
func (ec *Bitcoiin2gClient) GetTransactionReceipt(ctx *Context, hash *Hash) (receipt *Receipt, _ error) {
...
func (ec *Bitcoiin2gClient) SyncProgress(ctx *Context) (progress *SyncProgress, _ error) {
...
func (ec *Bitcoiin2gClient) SubscribeNewHead(ctx *Context, handler NewHeadHandler, buffer int) (sub *Subscription, _ error) {
...
func (ec *Bitcoiin2gClient) GetStorageAt(ctx *Context, account *Address, key *Hash, number int64) (storage []byte, _ error) {
	if number < 0 {
...
func (ec *Bitcoiin2gClient) GetCodeAt(ctx *Context, account *Address, number int64) (code []byte, _ error) {
	if number < 0 {
...
func (ec *Bitcoiin2gClient) GetNonceAt(ctx *Context, account *Address, number int64) (nonce int64, _ error) {
	if number < 0 {
...
func (ec *Bitcoiin2gClient) FilterLogs(ctx *Context, query *FilterQuery) (logs *Logs, _ error) {
...
func (ec *Bitcoiin2gClient) SubscribeFilterLogs(ctx *Context, query *FilterQuery, handler FilterLogsHandler, buffer int) (sub *Subscription, _ error) {
	// Subscribe to the event internally
...
func (ec *Bitcoiin2gClient) GetPendingStorageAt(ctx *Context, account *Address, key *Hash) (storage []byte, _ error) {
...
func (ec *Bitcoiin2gClient) GetPendingCodeAt(ctx *Context, account *Address) (code []byte, _ error) {
...
func (ec *Bitcoiin2gClient) GetPendingNonceAt(ctx *Context, account *Address) (nonce int64, _ error) {
...
func (ec *Bitcoiin2gClient) GetPendingTransactionCount(ctx *Context) (count int, _ error) {
...
func (ec *Bitcoiin2gClient) CallContract(ctx *Context, msg *CallMsg, number int64) (output []byte, _ error) {
	if number < 0 {
...
func (ec *Bitcoiin2gClient) PendingCallContract(ctx *Context, msg *CallMsg) (output []byte, _ error) {
	return ec.client.PendingCallContract(ctx.context, msg.msg)
}

// SuggestGasPrice retrieves the currently suggested gas price to allow a timely
// execution of a transaction.
func (ec *Bitcoiin2gClient) SuggestGasPrice(ctx *Context) (price *BigInt, _ error) {
...
func (ec *Bitcoiin2gClient) EstimateGas(ctx *Context, msg *CallMsg) (gas int64, _ error) {
...
func (ec *Bitcoiin2gClient) SendTransaction(ctx *Context, tx *Transaction) error {
