...
// Package accounts implements high level Bitcoiin2g account management.
package accounts
...
// Account represents an Bitcoiin2g account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // Bitcoiin2g account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain bitcoiin2g.ChainStateReader)
