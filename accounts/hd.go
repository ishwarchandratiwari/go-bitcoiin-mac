...
// the `coin_type` 60' (or 0x8000003C) to Bitcoiin2g.
//
// The root path for Bitcoiin2g is m/44'/60'/0'/0 according to the specification
// from https://github.com/bitcoiin2g/EIPs/issues/84, albeit it's not set in stone
