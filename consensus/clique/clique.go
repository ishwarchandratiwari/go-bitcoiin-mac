...
// ecrecover extracts the Bitcoiin2g account address from a signed header.
func ecrecover(header *types.Header, sigcache *lru.ARCCache) (common.Address, error) {
	...
	// Recover the public key and the Bitcoiin2g address
...
// Bitcoiin2g testnet following the Ropsten attacks.
type Clique struct {
	...
	signer common.Address // Bitcoiin2g address of the signing key
...
// Author implements consensus.Engine, returning the Bitcoiin2g address recovered
