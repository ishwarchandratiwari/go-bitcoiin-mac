...
// stock Bitcoiin2g ethash engine.
...
// rules of the stock Bitcoiin2g ethash engine.
...
func calcDifficultyByzantium(time uint64, parent *types.Header) *big.Int {
	// https://github.com/bitcoiin2g/EIPs/issues/100.
	// algorithm:
	// diff = (parent_diff +
	...
	//   https://github.com/bitcoiin2g/EIPs/pull/669
...
func calcDifficultyHomestead(time uint64, parent *types.Header) *big.Int {
	// https://github.com/bitcoiin2g/EIPs/blob/master/EIPS/eip-2.md
	// algorithm:
	// diff = (parent_diff +
