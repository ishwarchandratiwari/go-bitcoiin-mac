...
import (
	...
	"github.com/bitcoiinBT2/go-bitcoiin/les/flowcontrol"
	"github.com/bitcoiinBT2/go-bitcoiin/light"
...
func testChainGen(i int, block *core.BlockGen) {
	...
	switch i {
	case 0:
		// In block 1, the test bank sends account #1 some bitcoiin.
		tx, _ := types.SignTx(types.NewTransaction(block.TxNonce(testBankAddress), acc1Addr, big.NewInt(10000), params.TxGas, nil, nil), signer, testBankKey)
		block.AddTx(tx)
	case 1:
		// In block 2, the test bank sends some more bitcoiin to account #1.
