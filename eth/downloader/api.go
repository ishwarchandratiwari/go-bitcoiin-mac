...
// Syncing provides information when this nodes starts synchronising with the Bitcoiin2g network and when it's finished.
...
type SyncingResult struct {
	...
	Status  bitcoiin2g.SyncProgress `json:"status"`
}
