...
// Package bitcoiin2g defines interfaces for interacting with Bitcoiin2g.
package bitcoiin2g
...
type CallMsg struct {
	...
	GasPrice *big.Int        // gen <-> gas exchange ratio
	Value    *big.Int        // amount of gen sent along with the call
