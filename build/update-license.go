...
var (
	...
	authorsFileHeader = "# This is the official list of go-bitcoiin2g authors for copyright purposes.\n\n"
)

// this template generates the license comment.
// its input is an info structure.
var licenseT = template.Must(template.New("").Parse(`
// Copyright {{.Year}} The go-bitcoiin2g Authors
...
func (i info) Whole(startOfSentence bool) string {
	if i.gpl() {
		return "go-bitcoiin2g"
	}
	if startOfSentence {
		return "The go-bitcoiin2g library"
	}
	return "the go-bitcoiin2g library"
}
