...
func doXCodeFramework(cmdline []string) {
	...
	bind := gomobileTool("bind", "--target", "ios", "--tags", "ios", "-v", "github.com/bitcoiinBT2/go-bitcoiin/mobile")
	...
	if *deploy != "" {
		...
		build.Render("build/pod.podspec", "BitcoiinGo.podspec", 0755, meta)
		build.MustRunCommand("pod", *deploy, "push", "BitcoiinGo.podspec", "--allow-warnings", "--verbose")
	}
}
