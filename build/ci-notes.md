...
We want to build go-bitcoiin2g with the most recent version of Go, irrespective of the Go
...
can be edited at https://launchpad.net/%7Ebitcoiin2g/+archive/ubuntu/bitcoiin2g/+edit-dependencies
...
Then go into the source package directory for your running distribution and build the package:
    ...
    $ cd dist/bitcoiin2g-unstable-1.6.0+xenial
    $ dpkg-buildpackage
